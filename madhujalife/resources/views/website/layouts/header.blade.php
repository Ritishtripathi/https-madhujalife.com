...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <link rel="shortcut icon" href="{{ asset('website/img/madhujalife/logo.png') }}">
            ...
            <div class="col-md-4 col-lg-6 text-center">
                <div class="position-relative ps-4">
                    <div class="d-flex border rounded-pill">
                        <input class="form-control border-0 rounded-pill w-100 py-3" type="search"
            ...
            <div class="col-md-4 col-lg-3 text-center text-lg-end">
                <div class="d-inline-flex align-items-center">
                    <a href="#" class="text-muted d-flex align-items-center justify-content-center me-3"><span
                            class="rounded-circle btn-md-square border"><i class="fas fa-user"></i></i></a>
                    <a href="#" class="text-muted d-flex align-items-center justify-content-center me-3"><span
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-primary ">
                    <a href="" class="navbar-brand d-block d-lg-none">
                        {{-- <h1 class="display-5 text-secondary m-0"><i
                                class="fas fa-shopping-bag text-white me-2"></i>Madhujalife</h1> --}}
                        <img src="{{ asset('website/img/madhujalife/logo.png') }}" class="logo-img"  alt="Logo">
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav ms-auto py-0">
                            ...
                            <a href="{{ route('shop') }}" class="nav-item nav-link">Shop Now</a>
                            ...
                            <a href="{{ route('about') }}" class="nav-item nav-link me-2">About Us</a>
                            <a href="{{ route('contact') }}" class="nav-item nav-link me-2">Contact Us</a>
