            ...
            <div class="row g-4">
                <div class="col-lg-5 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div class="featured-product mb-4">
                        ...
                        <div class="featured-product-item">
                            <div class="rounded me-4" style="width: 100px; height: 100px;">
                                <img src="{{ asset('website/img/product-6.png') }}" class="img-fluid rounded" alt="Image">
                            </div>
                            <div>
                                <h6 class="mb-2">Smart Camera</h6>
                                <div class="d-flex mb-2">
                        ...
                        <div class="featured-product-item">
                            <div class="rounded me-4" style="width: 100px; height: 100px;">
                                <img src="{{ asset('website/img/product-7.png') }}" class="img-fluid rounded" alt="Image">
                            </div>
                            <div>
                        ...
                        <div class="featured-product-item">
                            <div class="rounded me-4" style="width: 100px; height: 100px;">
                                <img src="{{ asset('website/img/product-8.png') }}" class="img-fluid rounded" alt="Image">
                            </div>
                            <div>
                                <h6 class="mb-2">Smart Camera</h6>
                                <div class="d-flex mb-2">
                        ...
                        <div class="col-xl-6">
                            <div class="single-carousel owl-carousel">
                                <div class="single-item"
                                    data-dot="<img class='img-fluid' src='{{ asset('website/img/product-4.png') }}' alt=''>">
                                    <div class="single-inner bg-light rounded">
                                        <img src="{{ asset('website/img/product-4.png') }}" class="img-fluid rounded"
                                            alt="Image">
                                    </div>
                                </div>

                                <div class="single-item"
                                    data-dot="<img class='img-fluid' src='{{ asset('website/img/product-5.png') }}' alt=''>">
                                    <div class="single-inner bg-light rounded">
                                        <img src="{{ asset('website/img/product-5.png') }}" class="img-fluid rounded"
                                            alt="Image">
                                    </div>
                                </div>

                                <div class="single-item"
                                    data-dot="<img class='img-fluid' src='{{ asset('website/img/product-6.png') }}' alt=''>">
                                    <div class="single-inner bg-light rounded">
                                        <img src="{{ asset('website/img/product-6.png') }}" class="img-fluid rounded"
                                            alt="Image">
                                    </div>
                                </div>

                                <div class="single-item"
                                    data-dot="<img class='img-fluid' src='{{ asset('website/img/product-7.png') }}' alt=''>">
                                    <div class="single-inner bg-light rounded">
                                        <img src="{{ asset('website/img/product-7.png') }}" class="img-fluid rounded"
                                            alt="Image">
                                    </div>
                                </div>

                                <div class="single-item"
                                    data-dot="<img class='img-fluid' src='{{ asset('website/img/product-3.png') }}' alt=''>">
                                    <div class="single-inner bg-light rounded">
                                        <img src="{{ asset('website/img/product-3.png') }}" class="img-fluid rounded"
                                            alt="Image">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="tab-content mb-5">
                                ...
                                <div class="tab-pane" id="nav-mission" role="tabpanel" aria-labelledby="nav-mission-tab">
                                    <div class="d-flex">
                                        <img src="{{ asset('website/img/avatar.jpg') }}" class="img-fluid rounded-circle p-3"
